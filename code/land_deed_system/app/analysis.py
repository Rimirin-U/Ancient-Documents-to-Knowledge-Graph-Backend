    ...
    def analyze_power_structure(self) -> Dict[str, Any]:
        ...
        for node_id in self.graph.nodes:
            ...
            for r in entity.relations:
                if "Seller" in r.role: role_counts["Seller"] += 1
                elif "Buyer" in r.role: role_counts["Buyer"] += 1
                elif "Middleman" in r.role or "中人" in r.role or "代笔" in r.role: role_counts["Middleman"] += 1
            ...
            if betweenness_centrality[node_id] > 0.1: 
                tags.append("核心节点")
            ...
            if role_counts["Middleman"] >= 3:
                ...
                tags.append("中介")
            elif role_counts["Middleman"] > 0 and betweenness_centrality[node_id] > 0.05:
